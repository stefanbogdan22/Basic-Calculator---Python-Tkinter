...
ecran = Entry(width=35, borderwidth=5,)
ecran.grid(row=0, column=0, columnspan=3, padx=10, pady=10)
...
def button_equal():
    second_numer = ecran.get()
    ecran.delete(0, END)
    if math == "addition":
        ecran.insert(0, f_num + int(second_numer))
